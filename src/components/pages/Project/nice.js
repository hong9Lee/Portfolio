        ...
        <main className="main" style={{clear : "both"}}>
            ...
            <section className="outline">
                <div className="u_line">
                    <h2>프로젝트 개요</h2>
                    <p>과거에 사람이 직접 손으로 기술하던 기업에 대한 의견을 자동화 시스템으로 구축 하는 프로젝트</p>
                    ...
                    <br/>
                    <h2>1. 설계</h2>
                    <p>OOP를 활용하여 필요한 데이터를 파라미터로 입력받아 리소스 파일에 설정된 값에 의해 <br/>
                        요청한 의견에 대한 완성문장을 반환하는 솔루션을 설계</p>


                    <br/>
                    <br/>
                    <h2>2. 데이터 색인</h2>
                    <p>약 1억 3천만건의 원천DB를 Logstash를 이용해 ElasticSearch에 수집</p>
                    ...
                    */}
                    ...
                    <p>그 값에 해당하는 표현식을 표현식 Script 에서 찾아 문장을 만들어 return</p>
